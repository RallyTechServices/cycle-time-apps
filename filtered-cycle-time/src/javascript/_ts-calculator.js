Ext.define('CycleCalculator', {
    ...
    runCalculation: function(snapshots) {
         ...
         console.log('buckets',date_buckets);
         var cycle_time_data = [];
